  ...
  return (
    <div className="popup-overlay">
      <div className="popup-container how-to-vote-popup">
        ...
        <div className="popup-content" style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
          {step === 1 ? (
            <div className="step-one-wrapper">
              ...
              />
              <h2 className="popup-title" style={{ marginTop: "0px" }}>How to Vote</h2>
              <p className="popup-message" style={{ padding: "10px 20px", marginTop: "8px" }}>
                For each matchup, pick the photo you like best! Simply click on the Vote button or anywhere on the photo to submit your vote.
              </p>
            </div>
          ) : (
          ...
          <div className="popup-button">
            <SubmitButton onClick={handleNext} text={step === 1 ? "Next" : "Let’s Go!"} />
          </div>
        </div>
      </div>
    </div>
