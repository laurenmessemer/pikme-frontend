...
import flashIcon from "../../assets/icons/flash.svg"; // ✅ Import fixed icon
    ...
    return (
        <div className="submission-wallet">
            ...
            <div className="submission-wallet-header">
                <img src={flashIcon} alt="Contest Icon" className="contest-icon" /> {/* ✅ Fixed Icon */}
            ...
            <div className="submission-wallet-container">
                <div className="wallet-section">
                    ...
                    <div className="wallet-row">
                        ...
                        <strong className="wallet-value">{balance.toLocaleString(undefined, { minimumFractionDigits: 0 })} x 🟠</strong>
                    </div>
                </div>
