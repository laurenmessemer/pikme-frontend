...
import Placeholder from "../../assets/placeholders/frog.jpg";
...
const HeadStats = () => {
    ...
    const mockContestData = {
        ...
        leaderboard: [
            { id: 1, username: "SunsetLover21", imageUrl: {Placeholder}, votes: 200, earnings: "$2500" },
            { id: 2, username: "OceanBreeze", imageUrl: {Placeholder}, votes: 175, earnings: "$1000" },
            { id: 3, username: "GoldenHourPro", imageUrl: {Placeholder}, votes: 150, earnings: "$500" }
        ],
        maxWinners: 3
    };
            ...
            <div className="headstats-header">
                ...
                <div>
                    ...
                    <p className="contest-details">
                        {mockContestData.entries} Entries 
                    </p>
                    ...
                    <Dropdown title="Payout Details">
                        <div className="payout-table-container">
                            <table className="payout-table">
                                ...
                                <tbody>
                                    <tr><td>🥇 1st</td><td>$2500</td></tr>
                                    <tr><td>🥈 2nd</td><td>$1000</td></tr>
                                    <tr><td>🥉 3rd</td><td>$500</td></tr>
                                </tbody>
                            </table>
                        </div>
                    </Dropdown>
            ...
            <div className="headstats-content">
                ...
                <div className="leaderboard-column">
                    <div className="leaderboard-card user-submission">
                        <img src={mockContestData.userSubmission.imageUrl} alt="Your Submission" className="submission-image" />
                        <div className="user-info">
                            <p className="username">{mockContestData.userSubmission.username}</p>
                            <p className="user-votes">{mockContestData.userSubmission.votes} Votes</p>
                        </div>
                    ...
                    {/* Leaderboard Users */}
                    {mockContestData.leaderboard.slice(0, mockContestData.maxWinners).map((user) => (
