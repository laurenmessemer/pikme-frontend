        ...
        <div className="payout-container">
            ...
            {isOpen && (
                <div className="payout-dropdown">
                    <p><strong>1st Place:</strong> {payoutDetails.first || "$500"}</p>
                    <p><strong>2nd Place:</strong> {payoutDetails.second || "$300"}</p>
                    <p><strong>3rd Place:</strong> {payoutDetails.third || "$200"}</p>
                </div>
            )}
        </div>
    );
